...
public class FavMovieWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.kingleoners.mycinema.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.kingleoners.mycinema.EXTRA_ITEM";
